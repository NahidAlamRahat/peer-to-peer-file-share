...
class _ReceiveScreenState extends State<ReceiveScreen> {
  ...
  void _startDownload() {
    // When explicit download is clicked, we proceed to let the TransferScreen
    // know it can start. Actually, WebRTC connection happens AFTER joining successfully,
    // which generates ConnectionConnected. We wait here until metadata is received.
    // So if metadata is here, we are already connected! Next screen manages the transfer.
